  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: `${appUrl}/chat/auth/callback`,
        },
      });
      ...
      <div className="w-full max-w-sm">
        ...
        {success ? (
          <div className="text-center">
            ...
            <Link href="/chat/login" className="text-indigo-600 text-sm font-medium hover:underline">
              Back to sign in
            </Link>
          </div>
        ) : (
          <>
            ...
            <p className="text-sm text-gray-500 text-center mt-6">
              ...
              <Link href="/chat/login" className="text-indigo-600 font-medium hover:underline">
                Sign in
              </Link>
            </p>
          </>
